...
ENV_NAME = 'AirHockey-v0'  # Environment name
FRAME_WIDTH = 84  # Resized frame width
FRAME_HEIGHT = 84  # Resized frame height
NUM_EPISODES = 30  # Number of episodes the agent plays
STATE_LENGTH = 84  # Number of most recent frames to produce the input to the network
...
NO_OP_STEPS = 3  # Maximum number of "do nothing" actions to be performed by the agent at the start of an episode
LOAD_NETWORK = False
TRAIN = True
